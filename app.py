...
def projects_section():
    content = """
        ...
        <p><a href="https://commercial-sales-dashboard.streamlit.app/" class="hover-move-effect"><button class="moving-text-btn">Tableau de Bord d'Analyse Commerciale</button></a></p>
